...
while len(parameter_sample) < sample_size:
	...
	for surface in range(1):
		for phase in range(1):
			...
			#euclidean_distance += Distance(one_run,Detergent_Means[surface][phase],1)#Detergent_SD[surface][phase])
	...
	for surface in range(1):
		for phase in range(1):
			...
			#euclidean_distance += Distance(one_run,Disinfectant_Means[surface][phase]1)#,Disinfectant_SD[surface][phase]
	...
	for surface in range(1):
		for phase in range(1):
			...
			# euclidean_distance += Distance(one_run,Distilled_Means[surface][phase],1) #Distilled_SD[surface][phase]
